...
public class TERenderer {
    ...
    // draws tiles up to 5 away when toggled
    public void drawVisibleTiles(TETile[][] world, int avatarX, int avatarY) {
        int numXTiles = avatarX + 5;
        int numYTiles = avatarY + 5;

        for (int x = avatarX - 4; x < numXTiles; x += 1) {
            for (int y = avatarY - 4; y < numYTiles; y += 1) {
